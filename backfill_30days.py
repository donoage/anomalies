#!/usr/bin/env python3
"""
Backfill 30 days of historical data and detect anomalies
"""
...
def main():
    logger.info("=" * 60)
    logger.info("BACKFILLING 30 DAYS OF MARKET DATA")
    logger.info("=" * 60)
    logger.info("This will fetch data, build lookup tables, and detect anomalies")
    logger.info("With unlimited API plan, this should be fast!")
    logger.info("")
